...
roost_feedback [5/3/2024, 4:37:28 AM]:Fix this error seen when running pytest --cov -v 
```
    return compile(source, filename, mode, flags,
E     File /Users/harishagrawal/go/src/github.com/harishagrawal/python-mini-projects/projects/Billing_system/test_BillAppExitApp.py, line 152
E       monkeypatch.setattr(root, destroy, lambda: raise Exception(Mocked error))
E                                                    ^^^^^
...
class TestBillAppExitApp:
    ...
    def test_exit_app_error_handling(self, monkeypatch):
        ...
        monkeypatch.setattr(root, 'destroy', lambda: Exception("Mocked error"))
